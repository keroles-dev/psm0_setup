...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_fg, col_bg_cyan,  col_bg_cyan  },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_bg, "-nf", col_fg, "-sb", col_bg_cyan, "-sf", col_fg, NULL };
